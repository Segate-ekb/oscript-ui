...
**С телефона.** На узком экране разделы дома настроек уходят под кнопку «три черты»:
панель выезжает слева, закрывается повторным нажатием, клавишей Esc и щелчком мимо.
Открывает и закрывает её движок браузера — скрипта в ките нет ни строки.
