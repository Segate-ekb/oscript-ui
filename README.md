...
| `ОбрамлениеИнсталляции` | пустое обрамление | знак, подпись подвала, язык, иконки, адреса ходов (корень, вход, кабинет, выход, переключение оформления), разделы верхней и приватной навигации и имя вошедшего |
